...
The DudaMobile WordPress plugin makes it incredibly easy to build a mobile-friendly version of your WordPress website. Fast, reliable and (most importantly) FREE, the DudaMobile mobile website builder plugin has tons of mobile templates to choose from and works with all WordPress themes! Your regular WordPress site won’t be affected in anyway. 

# **A Few Highlights:**

*   In just a few clicks, you’ll have a mobile-friendly version of your WordPress site
...
DudaMobile Mobile Website Builder provides you with access to tons of mobile-friendly features designed to make your mobile site look great, drive customer action and make customizing your site simple. All these features can be added or removed using Duda’s drag-and-drop editor. 
...
Download and install the DudaMobile Mobile Website Builder plugin then click the “Get Started” button. DudaMobile will then look at your desktop site and make a new mobile-friendly version.
...
Publish the site and set up the mobile redirect by heading back to the DudaMobile plugin in your WordPress dashboard.
...
= How does DudaMobile Mobile Website Builder auto-sync my mobile website with my Wordpress website? =
