...
The DudaMobile WordPress plugin makes it incredibly easy to create a mobile-friendly version of your WordPress website. Fast, reliable and (most importantly) FREE, the DudaMobile plugin has tons of mobile templates to choose from and works with all WordPress themes! Your regular WordPress site won’t be affected in anyway. 
...
DudaMobile provides you with access to tons of mobile-friendly features designed to make your mobile site look great, drive customer action and make customizing your site simple. All these features can be added or removed using Duda’s drag-and-drop editor. 
...
*Step 1*
Download and install the DudaMobile WordPress plugin then click the “Get Started” button. DudaMobile will then look at your desktop site and make a new mobile-friendly version.
